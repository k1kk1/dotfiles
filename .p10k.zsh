# Generated by Powerlevel10k configuration wizard on 2021-06-10 at 19:58 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%009F'  # lightred foreground
      local   modified='%009F'  # lightredforeground
      local  untracked='%009F'  # lightred foreground
      local conflicted='%009F'  # lightred foreground
    else
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_CLOR=244
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=009
